...
void init_drv_UART(){
    ...
    UARTConfigSetExpClk(UART0_BASE, SysCtlClockGet(), BAUD_RATE_UART0, UART_CONFIG_WLEN_8|UART_CONFIG_STOP_ONE|UART_CONFIG_PAR_NONE);
    ...
    UARTConfigSetExpClk(UART1_BASE, SysCtlClockGet(), BAUD_RATE_UART1,(UART_CONFIG_WLEN_8 | UART_CONFIG_STOP_ONE | UART_CONFIG_PAR_NONE));
