...
#define SERVO_1_BASE    GPIO_PORTG_BASE
#define SERVO_1_PIN     GPIO_PIN_0
#define SERVO_2_BASE    GPIO_PORTG_BASE
...
#define PWM_SERVO_1_BASE PWM0_BASE
#define PWM_SERVO_1_OUT  PWM_OUT_4
#define PWM_SERVO_2_BASE PWM0_BASE
#define PWM_SERVO_2_OUT  PWM_OUT_5
